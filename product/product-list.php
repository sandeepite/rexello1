...
<body style="background: #F1F1F1; background:url(../images/background.png")>
    ...
    <!-- Navigation -->
<?php include ("../common_files/header1.php")?>
    <!-- Page Content -->
    <div class="container">
...
<ul class="pagination pagination-sm" style="margin:7px;">
    <li class="active"><a href="#"><i class="glyphicon glyphicon-th-list"></i></a></li>
    <li><a href="product-grid.php"><i class="glyphicon glyphicon-th"></i></a></li>
  </ul>
                       </div>
                       <div class="col-md-2">
                ...
                <div class="panel panel-default text-center">
                    <div class="panel-heading" style="height:150px;">
                        <span class="fa-stack fa-5x">
                           <img src="../images/cas.png" class="img-responsive"> 
                        </span>
    ...
    <span class="fa-stack fa-1x" style="width:4em; line-height: 0em;"><a href="#"> <img src="../images/cc.png" class="img-responsive"></a>200 mm</span>
    </div>
     <div class="col-md-4 col-xs-4">
      <span class="fa-stack fa-1x" style="width:4em; line-height: 0em;"><a href="#"> <img src="../images/mm.png" class="img-responsive"></a>500 mm</span>
      </div>
      <div class="col-md-4 col-xs-4 pull-right">
        <span class="fa-stack fa-1x" style="width:4em; line-height: 0em;"><a href="#"> <img src="../images/kg.png" class="img-responsive"></a>105 kg</span>
        </div>
                    </div>
         ...
         <div class="col-md-9">
                            <a href="#l"><h3>RD1/PT/P/138</h3></a>
                            <br><br>
                            <div class="col-md-7">
                                <p><strong>Description:</strong><br>
                                Wheel centre made of Polymer, plain bearing</p>
                                <br><br>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                                <a class="btn-text" href="#">
                                    <small><i class="fa fa-plus-square"></i> Add to wishlist</small>
                                </a><br> 
                                                                <a class="btn-text" href="#"><small><i class="fa fa-plus-square"></i> Send Request</small></a><br><br>
                                                                <a href="product-details.php" class="btn btn-tente"><i class="glyphicon glyphicon-chevron-right"></i>Know More</a> 
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <a class="btn-text" href="#">
                                    <small><i class="fa fa-plus-square"></i> Add to wishlist</small>
                                                                ...
                                                                <a class="btn-text" href="#"><small><i class="fa fa-plus-square"></i> Send Request</small></a><br><br>
                                                                <a href="#" class="btn btn-tente"><i class="glyphicon glyphicon-chevron-right"></i>Know More</a> 
                            </div>
                        </div>
...
<ul class="pagination pagination-sm" style="margin:7px;">
    ...
    <li class="active"><a href="lightduty.php"><i class="glyphicon glyphicon-th"></i></a></li>
  </ul>
                       </div>
                       <div class="col-md-2">
                       <select class="pagination btn btn-default btn-sm dropdown-toggle" onChange="setLocation(this.value)" style="margin:7px;">
    ...
    <div class="panel-body" id="">
        <div class="row">
            <div class="col-md-12" style="margin-bottom:10px;">
                ...
                <input class="form-control input-sm" type="text" onChange="updateFormFields(this);" name="q" value="">
            </div>
        </div>  
        ...
        <div class="row">
            <div class="col-md-12" style="margin-bottom:10px;">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <select name="wheel-diameter-min" onChange="validateSelectMinChange(this); updateFormFields(this);" class="form-control input-sm">
    ...
    <!-- /.container -->
 <footer>
           <?php include ("../common_files/footer1.php")?> 
        </footer>
  <!-- jQuery -->
